local e=Fox.GetPlatformName()local a=""if GrTools then
a=GrTools.GetDeviceName()end
if(Fox.GetDebugLevel()==Fox.DEBUG_LEVEL_QA_RELEASE)then
local e="Debug/qdebug_init.lua"local t=io.open(e,"r")if t~=nil then
...
GrTools.FontSystemInit(((1024*1024)*7))else
...
local o
if Editor then
t=Editor{name="MainEditor"}o=t
elseif EditorBase then
t=EditorBase{name="MainEditor"}o=t
else
...
if o then
o:Setup()if Editor then
Editor.Setting(o)end
local t=o:CreateNewEditableBucket"NewBucket"o:SetCurrentEditableBucket(t)if e=="Windows"then
