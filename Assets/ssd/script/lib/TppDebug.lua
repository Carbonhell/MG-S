...
return{}end
local e={}function e.SetPlayLogEnabled(e)if TppPlayLog then
TppPlayLog.SetPlayLogEnabled(e)end
end
function e.RequestResetPlayLog()if TppPlayLog then
TppPlayLog.RequestResetPlayLog()end
end
function e.RequestUploadPlayLog()if TppPlayLog then
TppPlayLog.RequestUploadPlayLog()end
end
function e.ExportSavedPlayLog()if TppPlayLog and TppPlayLog.ExportSavedPlayLog then
TppPlayLog.ExportSavedPlayLog()end
end
e.PERF_CHECK_TYPE=Tpp.Enum{"OnUpdate","OnMessage","OnEnter"}local n={}local c={}local s={}local p=2
local t=0
local d=0
...
e.Colors={black=Color(0,0,0,1),white=Color(1,1,1,1),red=Color(1,0,0,1),green=Color(0,1,0,1),blue=Color(0,0,1,1),yellow=Color(1,1,0,1),magenta=Color(1,0,1,1),cyan=Color(0,1,1,1),darkRed=Color(.5,0,0,1),darkGreen=Color(0,.5,0,1),darkBlue=Color(0,0,.5,1),darkYellow=Color(.5,.5,0,1),purple=Color(.5,0,.5,1),darkCyan=Color(0,.5,.5,1)}function e.DEBUG_SetSVars(e)if not i(e)then
return
end
...
function e.DEBUG_SetGVars(e)if not i(e)then
return
end
for e,a in pairs(e)do
...
function e.DEBUG_RestoreSVars()if next(Tpp._DEBUG_svars)then
for a,e in pairs(Tpp._DEBUG_svars)do
svars[a]=e
end
TppSave.VarSave()end
end
function e.DEBUG_SetOrderBoxPlayerPosition()if next(Tpp._DEBUG_gvars)then
...
function e.DEBUG_SVarsClear()if next(Tpp._DEBUG_svars)then
...
local a=i(a)e(a,{id="SetEnabled",enabled=false})e(a,{id="SetSneakRoute",route=o,point=r})e(a,{id="SetCautionRoute",route=o,point=r})if t then
...
local a=i(n)e(a,{id="SetPosition",position=d,rotY=0})end
function e.DEBUG_WarpVehicleAndSoldier(o,d,t,n,r,l)if not i(o)then
o={o}end
local i=GameObject.GetGameObjectId
...
local e=i(e)a(e,{id="SetEnabled",enabled=false})a(e,{id="SetSneakRoute",route=t,point=r})a(e,{id="SetCautionRoute",route=t,point=r})if l then
a(e,{id="SetAlertRoute",enabled=true,route=t,point=r})else
a(e,{id="SetAlertRoute",enabled=false,route="",point=r})end
a(e,{id="SetEnabled",enabled=true})end
local r=i(d)a(r,{id="SetPosition",position=n,rotY=0})end
e.DEBUG_SkipOnChangeSVarsLog={timeLimitforSneaking=true,timeLimitforNonAbort=true,displayTimeSec=true}function e.DEBUG_AddSkipLogSVarsName(a)e.DEBUG_SkipOnChangeSVarsLog[a]=true
end
function e.DEBUG_FobGPU()local e=function(a)math.randomseed(os.time())TppMotherBaseManagement.SetGmp{gmp=1e6}local e=300
...
e(90)end
function e.DEBUG_SetFobPlayerSneak()vars.avatarFaceRaceIndex=0
...
function e.DEBUG_SetFobPlayerDefence()vars.avatarFaceRaceIndex=0
vars.avatarAcceFlag=0
vars.avatarFaceTypeIndex=1
vars.avatarFaceVariationIndex=1
vars.avatarFaceColorIndex=0
...
e.AddDebugMenu(" Select","Return select","bool",mvars.qaDebug,"returnSelect")e.AddDebugMenu("LuaSystem","showSysVars","bool",gvars,"DEBUG_showSysVars")e.AddDebugMenu("LuaSystem","gameStatus","bool",gvars,"DEBUG_showGameStatus")mvars.qaDebug.warpToBase=false
e.AddDebugMenu(" DebugWarp","WarpToBase","bool",mvars.qaDebug,"warpToBase")mvars.qaDebug.forceCheckPointSave=false
e.AddDebugMenu("LuaSystem","ForceCheckPointSave","bool",mvars.qaDebug,"forceCheckPointSave")mvars.qaDebug.forceMissionReload=false
e.AddDebugMenu("LuaSystem","MissionReload","bool",mvars.qaDebug,"forceMissionReload")mvars.qaDebug.showWeaponVars=false
...
e.AddDebugMenu("LuaSystem","setFobForGPU","bool",mvars.qaDebug,"setFobForGPU")mvars.qaDebug.setInitialInventory=false
e.AddDebugMenu("LuaSystem","setInitialInventory","bool",mvars.qaDebug,"setInitialInventory")mvars.qaDebug.setInitialBuilding=false
e.AddDebugMenu("LuaSystem","setInitialBuilding","bool",mvars.qaDebug,"setInitialBuilding")mvars.qaDebug.resetAllBuilding=false
e.AddDebugMenu("LuaSystem","resetAllBuilding","bool",mvars.qaDebug,"resetAllBuilding")mvars.qaDebug.setFullBuildingLv2=false
e.AddDebugMenu("LuaSystem","setFullBuildingLv2","bool",mvars.qaDebug,"setFullBuildingLv2")mvars.qaDebug.showUnlockedFastTravel=false
e.AddDebugMenu("LuaSystem","showUnlockedFastTravel","bool",mvars.qaDebug,"showUnlockedFastTravel")mvars.qaDebug.showSavedGVarsFlag=false
e.AddDebugMenu("LuaSystem","showSavedGVarsFlag","bool",mvars.qaDebug,"showSavedGVarsFlag")mvars.qaDebug.setZombieBaitParam=false
e.AddDebugMenu(" <Ssd>","setZombieBaitParam","bool",mvars.qaDebug,"setZombieBaitParam")mvars.qaDebug.showEventTask=false
e.AddDebugMenu("LuaUI","showEventTask","bool",mvars.qaDebug,"showEventTask")mvars.qaDebug.returnToAfghBase=false
e.AddDebugMenu(" MatchingRoom","ReturnToAfghBase","bool",mvars.qaDebug,"returnToAfghBase")mvars.qaDebug.returnToMafrBase=false
e.AddDebugMenu(" MatchingRoom","ReturnToMafrBase","bool",mvars.qaDebug,"returnToMafrBase")mvars.qaDebug.returnToMatchingRoom=false
e.AddDebugMenu(" MatchingRoom","ReturnToMatchingRoom","bool",mvars.qaDebug,"returnToMatchingRoom")end
function e.QAReleaseDebugUpdate()local i=svars
local a=mvars
local r=DebugText.Print
local o=DebugText.NewContext()if a.qaDebug then
local e=(DebugMenu.GetDebugMenuValue(" <Ssd>","OfflineMode")=="ON")if e then
r(o,{1,.1,.1},"OFFLINE MODE")end
end
if a.qaDebug.returnSelect then
TppUI.FadeOut(0)SsdUiSystem.RequestForceClose()TitleMenuSystem.RequestClose()TppSave.ReserveVarRestoreForMissionStart()TppMission.SafeStopSettingOnMissionReload()tpp_editor_menu2.StartTestStage(6e4)a.qaDebug.returnSelect=false
end
if a.qaDebug.warpToBase then
local e={afgh=Vector3(-442,288,2239),mafr=Vector3(2790,96,-910)}if a.ply_deliveryWarpState~=TppPlayer.DELIVERY_WARP_STATE.START_WARP then
local r=Vector3(vars.playerPosX,vars.playerPosY,vars.playerPosZ)local o=TppLocation.GetLocationName()if e[o]then
r=e[o]end
a.qaDebug.warpToBase=false
local e={type="TppPlayer2",index=0}local a={id="WarpAndWaitBlock",pos=r,unrealize=true}GameObject.SendCommand(e,a)end
end
...
r(o,{1,.5,.5},"TppSave.EraseAllGameDataSaveRequest : erase game data save request!")TppSave.DEBUG_EraseAllGameDataCounter=TppSave.DEBUG_EraseAllGameDataCounter-Time.GetFrameTime()else
TppSave.DEBUG_EraseAllGameDataCounter=nil
end
end
if a.qaDebug.forceCheckPointSave then
a.qaDebug.forceCheckPointSave=false
TppMission.VarSaveOnUpdateCheckPoint()end
if gvars.DEBUG_showSysVars then
local e=e.DEBUG_GetSysVarsLog()r(o,{.5,.5,1},"LuaSystem showSysVars")r(o,"hordeTimer = "..tostring(vars.timeUntilNextHorde))for a,e in ipairs(e)do
r(o,e)end
local e={[FobMode.MODE_ACTUAL]="MODE_ACTUAL",[FobMode.MODE_SHAM]="MODE_SHAM",[FobMode.MODE_VISIT]="MODE_VISIT",[FobMode.MODE_NONE]="MODE_NONE"}r(o,"killCount = "..tostring(i.killCount))r(o,"totalKillCount = "..tostring(gvars.totalKillCount))end
if gvars.DEBUG_showGameStatus then
r(o,"")r(o,{.5,.5,1},"LuaSystem gameStatus")for a,e in pairs(TppDefine.GAME_STATUS_TYPE_ALL)do
local e=TppGameStatus.IsSet("TppMain.lua",a)if e then
r(o," statusType = "..(tostring(a)..(", IsSet = "..tostring(e))))end
end
local e=TppGameStatus.IsSet("TppMain.lua","S_IS_BLACK_LOADING")if e then
r(o," statusType = "..(tostring"S_IS_BLACK_LOADING"..(", IsSet = "..tostring(e))))end
r(o,"UIStatus")local e={{CallMenu="INVALID"},{PauseMenu="INVALID"},{EquipHud="INVALID"},{EquipPanel="INVALID"},{CqcIcon="INVALID"},{ActionIcon="INVALID"},{AnnounceLog="SUSPEND_LOG"},{AnnounceLog="INVALID_LOG"},{BaseName="INVALID"},{Damage="INVALID"},{Notice="INVALID"},{HeadMarker="INVALID"},{WorldMarker="INVALID"},{HudText="INVALID"},{GmpInfo="INVALID"},{AtTime="INVALID"},{InfoTypingText="INVALID"},{ResourcePanel="SHOW_IN_HELI"}}for a,e in pairs(e)do
for a,e in pairs(e)do
if(TppUiStatusManager.CheckStatus(a,e)==true)then
r(o,string.format(" UI = %s, Status = %s",a,e))end
end
end
end
if a.qaDebug.showWeaponVars then
local e={"PRIMARY_HIP","PRIMARY_BACK","SECONDARY"}r(o,{.5,.5,1},"LuaSystem WeaponVars")for a,e in ipairs(e)do
local a=TppDefine.WEAPONSLOT[e]r(o,string.format("Slot:%16s : vars.initWeapons = %04d, vars.weapons = %04d",e,vars.initWeapons[a],vars.weapons[a]))end
for e=0,7 do
r(o,string.format("Slot:%d : vars.supportWeapons = %04d, vars.initSupportWeapons = %04d, gvars.ply_lastWeaponsUsingTemp = %04d",e,vars.supportWeapons[e],vars.initSupportWeapons[e],gvars.ply_lastWeaponsUsingTemp[e+TppDefine.WEAPONSLOT.SUPPORT_0]))end
for e=0,7 do
r(o,string.format("Slot:%d : vars.items = %04d, vars.initItems = %04d, gvars.ply_lastItemsUsingTemp = %04d",e,vars.items[e],vars.initItems[e],gvars.ply_lastItemsUsingTemp[e]))end
end
...
r(o,{.5,.5,1},"LuaUI ShowEventTask")local function d(i,e,d)local t
if FobUI.IsCompleteEventTask(e,d)then
t=" o "else
t=" x "end
local n=i[e]and i[e].detectType
if n then
local a=a.qaDebug.debugEventTaskTextTable and a.qaDebug.debugEventTaskTextTable[n]if not a then
a="threshold is"end
r(o,string.format("   Task %1d : [%s] %s %06.2f : ( Current %06.2f )",e,t,a,i[e].threshold,FobUI.GetCurrentEventTaskValue(e,d)))end
end
r(o,{.5,1,.5},"FobSneak eventTask")for o=0,7 do
local e=a.ui_eventTaskDefine.sneak
if e and e[o]then
d(e,o,true)end
end
r(o,{.5,1,.5},"FobDefence eventTask")for r=0,7 do
...
TppMission.Reload()end
if a.qaDebug.setInitialInventory then
a.qaDebug.setInitialInventory=false
SsdSbm.AddProduction{id="PRD_EQP_WP_Machete_A",tryEquip=true}SsdSbm.AddProduction{id="PRD_ACC_Body_21",tryEquip=true}SsdSbm.AddProduction{id="PRD_ACC_Foot_03",tryEquip=true}SsdSbm.AddProduction{id="PRD_ACC_Arm_06",tryEquip=true}end
if a.qaDebug.setInitialBuilding then
a.qaDebug.setInitialBuilding=false
TppVarInit.InitializeBuildingData(true)end
if a.qaDebug.resetAllBuilding then
a.qaDebug.resetAllBuilding=false
SsdBuilding.DEBUG_RemoveAllNetwork()end
if a.qaDebug.setFullBuildingLv2 then
a.qaDebug.setFullBuildingLv2=false
e.DEBUG_SetFullBuildingLv2()end
...
if i.showSVars then
o(r,"")o(r,{.5,.5,1},"LuaMission DBG.showSVars")for a,e in pairs(a.dbg_userSaveVarList)do
o(r,string.format(" %s = %s",tostring(e),tostring(t[e])))end
end
if i.showMVars then
o(r,{.5,.5,1},"LuaMission DBG.showMVars")for a,e in pairs(a)do
o(r,string.format(" %s = %s",tostring(a),tostring(e)))end
end
if i.showMissionArea then
o(r,{.5,.5,1},"LuaMission MIS.missionArea")local e
if a.mis_isOutsideOfMissionArea then
e="Outside"else
e="Inside"end
o(r,"outerZone : "..e)if a.mis_isAlertOutOfMissionArea then
e="Outside"else
e="Inside"end
o(r,"innerZone : "..e)if a.mis_isOutsideOfHotZone then
e="Outside"else
e="Inside"end
o(r,"hotZone : "..e)o(r,"hotZone clear check : isNotAlert = "..(tostring(a.debug.notHotZone_isNotAlert)..(", isPlayerStatusNormal = "..(tostring(a.debug.notHotZone_isPlayerStatusNormal)..(", isNotHelicopter = "..tostring(a.debug.notHotZone_isNotHelicopter))))))o(r,"Mission clear timer: "..tostring(u"Timer_OutsideOfHotZoneCount"))o(r,{.5,1,.5},"Recent all target status")local e=a.debug.checkedTargetStatus or{}for e,a in pairs(e)do
o(r,"  TargetName = "..(e..(" : "..a)))end
end
...
GkEventTimerManager.Stop(a.mis_openEmergencyMissionTimerName)GkEventTimerManager.Start(a.mis_openEmergencyMissionTimerName,1)end
end
if a.debug.closeEmergencyTimer then
a.debug.closeEmergencyTimer=false
if a.mis_closeEmergencyMissionTimerName then
GkEventTimerManager.Stop(a.mis_closeEmergencyMissionTimerName)GkEventTimerManager.Start(a.mis_closeEmergencyMissionTimerName,1)end
end
if i.showSysSVars then
o(r,"")o(r,{.5,.5,1},"LuaSystem DBG.showSysSVars")for e,a in pairs(t.__as)do
if(a<=1)then
o(r,string.format(" %s = %s",tostring(e),tostring(t[e])))else
o(r,string.format(" %s = %s",tostring(e),tostring(a)))for a=0,(a-1)do
o(r,string.format("   %s[%d] = %s",tostring(e),a,tostring(t[e][a])))end
end
end
end
if i.showDebugPerfCheck then
o(r,{.5,.5,1},"LuaSystem DBG.showPerf")for i,a in pairs(s)do
o(r," perf["..(e.PERF_CHECK_TYPE[i]..("] = "..a)))end
end
if a.debug.AnimalBlock then
o(r,{.5,.5,1},"LuaSystem DBG.AnimalBlock")local t,i=Tpp.GetCurrentStageSmallBlockIndex()o(r,string.format("current block position (x,y) = (%03d, %03d)",t,i))o(r,"Load animal block area = "..tostring(a.animalBlockAreaName))local t=ScriptBlock.GetScriptBlockId"animal_block"local i
if t~=ScriptBlock.SCRIPT_BLOCK_ID_INVALID then
i=ScriptBlock.GetScriptBlockState(t)end
local t
...
o(r,"animal block state : "..tostring(t))if a.animalBlockScript then
o(r,"animalBlockScript exist")local i=""if a.animalBlockScript.OnMessage then
i="exist"else
i="  not"end
local t=""if a.animalBlockScript.OnReload then
t="exist"else
t="  not"end
o(r,"OnMessage "..(tostring(i)..(" OnReload "..tostring(t))))e.ShowMessageTable(r,"MessageTable",a.animalBlockScript.messageExecTable)else
...
o(r,{.5,.5,1},"LuaSystem PLY.intelTrap")for e,a in pairs(a.ply_intelTrapInfo)do
if Tpp.IsTypeString(e)then
o(r,{.5,1,.5},"intelName = "..tostring(e))for a,e in pairs(a)do
o(r,tostring(a)..(" = "..tostring(e)))end
end
end
end
if(i.showSubscriptMessageTable>0)then
o(r,{.5,.5,1},"LuaMessage subScripts")local o={"sequence","enemy","demo","radio","sound"}local o=o[a.debug.showSubscriptMessageTable]if o then
local i=TppMission.GetMissionName()..("_"..o)if a.rad_subScripts[o]then
local a=a.rad_subScripts[o]._messageExecTable
e.ShowMessageTable(r,i,a)end
end
end
if(i.showSequenceMessageTable>0)then
o(r,{.5,.5,1},"LuaMessage sequence")local o=TppSequence.GetSequenceNameWithIndex(a.debug.showSequenceMessageTable)if a.seq_sequenceTable then
local a=a.seq_sequenceTable[o]if a then
local a=a._messageExecTable
e.ShowMessageTable(r,o,a)end
end
end
if(i.showLocationMessageTable>0)then
o(r,{.5,.5,1},"LuaMessage location")end
if(i.showLibraryMessageTable>0)then
o(r,{.5,.5,1},"LuaMessage library")local a=Tpp._requireList[i.showLibraryMessageTable]local o=_G[a].messageExecTable
e.ShowMessageTable(r,a,o)end
if a.debug.showWeaponSelect then
o(r,{.5,.5,1},"LuaWeapon")if a.debug.weaponCategory<1 then
...
local t=a.debug.weaponCategoryList[a.debug.weaponCategory]o(r,{.5,1,.5},"Current weapon category : "..t[1])local l,s
local e,i,n=0,1,5
if a.debug.selectedWeaponId>0 then
i=a.debug.selectedWeaponId
end
for a,u in pairs(TppEquip)do
local g=string.sub(a,1,t[2])local d=false
...
l=u
s=a
o(r,{.5,1,.5},"> EquipId = TppEquip."..a)else
o(r,"  EquipId = TppEquip."..a)end
end
if e==(i+n)then
break
end
...
function e.ShowMessageTable(a,o,r)local e=DebugText.Print
e(a,{.5,1,.5},o)if r==nil then
return
end
for o,r in pairs(r)do
local i=l(o)if r then
for o,r in pairs(r)do
local o=l(o)if r.func then
e(a,{1,1,1},i..(" : "..(o..(" : "..tostring(r.func)))))end
local r=r.sender
if r then
for t,r in pairs(r)do
e(a,{1,1,1},i..(" : "..(o..(" : Sender = "..(l(t)..(" : "..tostring(r)))))))end
end
end
end
end
end
function e.PerfCheckStart(a)local e=e
if((a<=0)and(a>#e.PERF_CHECK_TYPE))then
return
end
if(a==e.PERF_CHECK_TYPE.OnUpdate)then
if(n[e.PERF_CHECK_TYPE.OnUpdate]~=nil)then
t=t+(os.clock()-n[e.PERF_CHECK_TYPE.OnUpdate])end
end
n[a]=os.clock()end
function e.PerfCheckEnd(a,r)local i=mvars
local o=e
if((a<=0)and(a>#o.PERF_CHECK_TYPE))then
return
end
local l=r or""local e=0
local r=os.clock()-n[a]if(a==o.PERF_CHECK_TYPE.OnUpdate)then
if(t<p)then
if(r>d)then
d=r
end
...
s[a]=string.format("%4.2f",e*1e3)..("ms."..l)if i.debug and i.debug.showDebugPerfCheck then
if(e>1/60)then
else
...
function e.ErrorNotSupportYet(e)end
function e._GetColor(a)local e=e.Colors[a]if(e==nil)then
return nil
end
return e
end
