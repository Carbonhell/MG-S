...
function e.IsPlayingSceneBGM(e)if(svars.snd_bgmNameHash==s(e))then
return true
else
return false
end
...
function e.PostEventForFultonRecover()TppSoundDaemon.PostEvent("sfx_m_fulton_heli_success","Loading")end
...
function e.DeclareSVars()return{{name="snd_bgmNameHash",type=TppScriptVars.TYPE_UINT32,value=0,save=false,sync=false,wait=false,category=TppScriptVars.CATEGORY_MISSION},{name="snd_bgmSwitchNameHash",type=TppScriptVars.TYPE_UINT32,value=0,save=false,sync=false,wait=false,category=TppScriptVars.CATEGORY_MISSION},{name="snd_phaseBgmTagHash",type=TppScriptVars.TYPE_UINT32,value=0,save=false,sync=false,wait=false,category=TppScriptVars.CATEGORY_MISSION},nil}end
...
mvars.snd_bgmList={}mvars.snd_bgmList.bgm_title={start="Play_SSD_BGM_sys_stup"}end
...
mvars.snd_bgmList.bgm_heliStart=mvars.snd_bgmList.bgm_heliStart
...
function e.OnMessage(t,r,a,l,s,i,n)Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,t,r,a,l,s,i,n)end
