...
e.SetUp()e.ReleaseFreePlay()TppUiCommand.SetAllInvalidMbSoundControllerVoice(false)TppUiCommand.ClearMbDvcOpenConditionRequest()end
function e.MakeMessage()e.messageExecTable=Tpp.MakeMessageExecTable(e.Messages())end
function e.OnReload(n)e.Init(n)e.MakeMessage()end
function e.OnMissionGameStart(e)end
function e.Messages()return Tpp.StrCode32Table{GameObject={{msg="Fulton",func=function(t,o,n,r)e.OnFultonMessage(t,o,n,r)end,option={isExecMissionClear=true,isExecDemoPlaying=true}},{msg="FultonInfo",func=function(t,o,n)e.OnFultonInfoMessage(t,o,n)end,option={isExecMissionClear=true,isExecDemoPlaying=true}},{msg="FultonFailedEnd",func=e.OnFultonFailedEnd}},Weather={{msg="WeatherForecast",func=e.TerminalVoiceWeatherForecast}}}end
function e.OnMessage(n,i,a,c,t,r,o)Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,n,i,a,c,t,r,o)end
function e.OnFultonMessage(e,n,o,t)mvars.trm_fultonInfo=mvars.trm_fultonInfo or{}mvars.trm_fultonInfo[e]={e,n,o,t}end
function e.OnFultonInfoMessage(o,t,r)mvars.trm_fultonInfo=mvars.trm_fultonInfo or{}local n=mvars.trm_fultonInfo[o]if n then
e.OnFulton(n[1],n[2],n[3],n[4],nil,nil,t,r)mvars.trm_fultonInfo[o]=nil
end
mvars.trm_fultonFaileEndInfo=mvars.trm_fultonFaileEndInfo or{}local n=mvars.trm_fultonFaileEndInfo[o]if n then
e._OnFultonFailedEnd(n[1],n[2],n[3],n[4],t)mvars.trm_fultonFaileEndInfo[o]=nil
end
end
function e.SetUp()e.SetUpStorySsdStart()TppUiStatusManager.UnsetStatus("Subjective","SUPPORT_NO_USE")end
function e.OnFulton(e,o,t,r,a,n,c,i)if n then
mvars.trm_needHeliSoundOnAddStaffsFromTempBuffer=true
end
TppEnemy.SetRecovered(e)TppEnemy.ExecuteOnRecoveredCallback(e,o,t,r,a,n,c)if Tpp.IsLocalPlayer(c)then
TppEnemy._OnFulton(e,o,t,r)end
end
...
function e.IsEqualOrMoreTotalFultonCount(n)local e=gvars.trm_recoveredSoldierCount+gvars.trm_recoveredHostageCount
if(e>=n)then
return true
else
return false
...
function e.IsRecoveredCompleatedGoat()return false
end
function e.IsRecoveredCompleatedHorse()return false
end
function e.IsRecoveredCompleatedDog()return false
end
function e.IsRecoveredCompleatedBear()return false
end
function e.GetAnimalTypeCountFromRecoveredHistory(o)local e=0
...
function e.AddAnimalRecoverHistory(n)local e=gvars.trm_animalRecoverHistorySize
...
function e.IsAnimalDog(e)return false
end
function e.IsAnimalHorse(e)return false
end
function e.IsAnimalBear(e)return false
end
function e.IsAnimalGoat(e)return false
end
function e.AddTempStaffFulton(e)end
function e.AddTempResource(e,e,e)end
function e.AddTempDataBase(e)end
function e.AddTempDataBaseAnimal(e,e)end
function e.AddPickedUpResourceToTempBuffer(e,e)end
function e.SetUpStorySsdStart()end
...
function e.OpenAllSection()end
function e.OnEstablishMissionClear()end
function e.ReleaseFreePlay()end
function e.PickUpBluePrint(t,o)local n=nil
if o then
n=o
else
n=mvars.trm_bluePrintLocatorIdTable[t]end
if not n then
return
end
e.AddTempDataBase(n)local e=e.BLUE_PRINT_LANG_ID[n]TppUI.ShowAnnounceLog("get_blueprint",e)end
function e.InitializeBluePrintLocatorIdTable()mvars.trm_bluePrintLocatorIdTable={}for e,n in pairs(e.BLUE_PRINT_LOCATOR_TABLE)do
local e=TppCollection.GetUniqueIdByLocatorName(e)mvars.trm_bluePrintLocatorIdTable[e]=n
end
end
...
function e.PlayTerminalVoice(n,e,o)if mvars.trm_voiceDisabled and e~=false then
return
end
TppUiCommand.RequestMbSoundControllerVoice(n,e,o)end
function e.OnFultonFailedEnd(e,t,n,o)mvars.trm_fultonFaileEndInfo=mvars.trm_fultonFaileEndInfo or{}mvars.trm_fultonFaileEndInfo[e]={e,t,n,o}end
function e._OnFultonFailedEnd(n,n,n,n,e)if Tpp.IsLocalPlayer(e)then
TppUI.ShowAnnounceLog"extractionFailed"end
end
function e.HasVehicle()return false
end
function e._SetUpDvcMenu(n)if not Tpp.IsTypeTable(n)then
return
end
TppUiCommand.InitAllMbTopMenuItemVisible(false)TppUiCommand.InitAllMbTopMenuItemActive(true)e.EnableDvcMenuByList(n)end
function e.EnableDvcMenuByList(e)for n=1,table.getn(e)do
if e[n]==nil then
return
else
TppUiCommand.SetMbTopMenuItemVisible(e[n].menu,true)if e[n].active~=nil then
TppUiCommand.SetMbTopMenuItemActive(e[n].menu,e[n].active)end
end
end
end
...
function e.SetActiveTerminalMenu(n)if not Tpp.IsTypeTable(n)then
return
end
if n[1]==e.MBDVCMENU.ALL then
TppUiCommand.InitAllMbTopMenuItemActive(true)else
TppUiCommand.InitAllMbTopMenuItemActive(false)for e=1,table.getn(n)do
if n[e]==nil then
return
else
TppUiCommand.SetMbTopMenuItemActive(n[e],true)end
end
end
end
return e