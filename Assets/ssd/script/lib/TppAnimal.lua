...
e.AnimalExtraId={UNIQUE_ANIMAL_00=TppAnimalId.COUNT+0,UNIQUE_ANIMAL_01=TppAnimalId.COUNT+1,UNIQUE_ANIMAL_02=TppAnimalId.COUNT+2,UNIQUE_ANIMAL_03=TppAnimalId.COUNT+3}e.AnimalIdTable={}e.AnimalNpcTypeTable={[a"Bear"]="SsdBear",[a"KashmirBear"]="SsdKashmirBear",[a"Wolf"]="SsdWolf",[a"Jackal"]="SsdJackal",[a"Lycaon"]="SsdLycaon",[a"Anubis"]="SsdAnubis"}function e.Messages()return Tpp.StrCode32Table{GameObject={{msg="NpcActivated",func=e.SetAnimalLevel,option={isExecDemoPlaying=true,isExecMissionPrepare=true,isExecFastTravel=true,isExecMissionClear=true,isExecGameOver=true}}}}end
...
function e.OnMessage(a,n,t,d,i,s,l)Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,a,n,t,d,i,s,l)end
...
function e.SetHerdRoute(e,t,a)local e={type=e,index=0}if e==n then
return
end
local n={id="SetHerdEnabledCommand",type="Route",name=t,instanceIndex=0,route=a}GameObject.SendCommand(e,n)end
...
function e.SetAnimalId(e,t,a)local e={type=e,index=0}if e==n then
return
end
local n={id="SetAnimalId",name=t,animalId=a}GameObject.SendCommand(e,n)end
...
function e.GetPackFileListFromInstanceInfo(n,t)local a={}if Tpp.IsTypeTable(t)then
a=t
else
table.insert(a,t)end
for t,a in ipairs(a)do
if SsdNpc.IsExistNpcType(a)then
local a=SsdNpc.GetGameObjectPackFilePathsFromNpcType{npcType=a}if a~=nil then
for t,a in ipairs(a)do
if not e._IsIncludeValueInTable(n,a)then
table.insert(n,a)end
end
end
else
if not e._IsIncludeValueInTable(n,a)then
...
function e.SetAnimalLevel(a,n)local e=e.AnimalNpcTypeTable[n]if not e then
return
end
local a,n=TppStory.GetMissionEnemyLevel()TppEnemy._SetEnemyLevel(e,a,n)end
...
local n={messageId="None",idType="animalId"}local i={messageId="None",idType="databaseId"}if mvars.ani_isQuestSetup==false then
...
function e._IsIncludeValueInTable(n,e)for a,n in pairs(n)do
if n==e then
return true
end
end
