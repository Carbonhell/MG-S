...
if DebugText then
local e=DebugText.NewContext()DebugText.Print(e,{.5,.5,1},"TppException : Mission initializing.")end
return e.PROCESS_STATE.SUSPEND
end
...
if DebugText then
local e=DebugText.NewContext()DebugText.Print(e,{.5,.5,1},"TppException : Now helicoppter space but cannot abort mission preparation.")end
return e.PROCESS_STATE.SUSPEND
else
return e.PROCESS_STATE.FINISH
end
...
if DebugText then
local e=DebugText.NewContext()DebugText.Print(e,{.5,.5,1},"TppException : wait fob stage initialized")end
return e.PROCESS_STATE.SUSPEND
end
if TppServerManager.FobIsSneak()then
TppMission.AbortMissionByMenu()else
TppMission.ReturnToMission{withServerPenalty=true}end
end
return e.PROCESS_STATE.FINISH
end
...
local t=gvars.exc_exceptionQueueDepth+1
if t>=TppDefine.EXCEPTION_QUEUE_MAX then
return
end
...
gvars.exc_exceptionQueueDepth=t
gvars.exc_exceptionQueue[o]=n
gvars.exc_queueGameMode[o]=i
end
function e.Dequeue(e)local n=e or 0
if n>gvars.exc_exceptionQueueDepth then
return
end
local t=gvars.exc_exceptionQueue[n]local o=gvars.exc_queueGameMode[n]local e=gvars.exc_exceptionQueueDepth
for e=n,(e-1)do
...
local t=e.GetCurrentGameMode()if e.currentErrorPopupLangId and TppUiCommand.IsShowPopup(e.currentErrorPopupLangId)then
...
function n:OnMessage(o,a,i,n,t,T)local r
Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOptionWhileLoading,o,a,i,n,t,T,r)end
