...
end},{sub={"s11080"},condition=function()local t=TppQuest.IsNowOccurringElapsed()local n=e.IsNowOccurringElapsedMission(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE)if t or n then
...
end,radioList={"f6000_rtrg0511"}},QuietTreatment={storyCondition=function(e)return e.demoName=="ArrivedMotherBaseAfterQuietBattle"end,detailCondition=function(e)local e=not TppRadio.IsPlayed"f2000_rtrg1345"local n=TppBuddyService.DidObtainBuddyType(BuddyType.QUIET)local t=TppQuest.IsOpen"sovietBase_q99020"local i=not TppQuest.IsCleard"sovietBase_q99020"return((e and n)and t)and i
end,radioList={"f2000_rtrg1345","f2000_rtrg1347"}},QuietTreatment2={storyCondition=function(e)return e.demoName=="ArrivedMotherBaseAfterQuietBattle"end,detailCondition=function(e)local e=not TppRadio.IsPlayed"f2000_rtrg1345"local t=TppBuddyService.DidObtainBuddyType(BuddyType.QUIET)local n=not TppQuest.IsOpen"sovietBase_q99020"local i=TppQuest.IsCleard"sovietBase_q99020"return(e and t)and(n or i)end,radioList={"f2000_rtrg1345","f2000_rtrg1346"}},QuietReceivesPersecution={storyCondition=function()local n=vars.missionCode==10085 or vars.missionCode==10200
...
end,radioList={"f6000_rtrg0350","f2000_rtrg7350"}},InterrogateQuiet={storyCondition=function()local t=TppQuest.IsNowOccurringElapsed()local n=e.IsNowOccurringElapsedMission(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE)local e=e.IsMissionCleard(10093)return(n or t)and e
...
end,detailCondition=function()local n=TppRadio.IsPlayed"f2000_rtrg8090"local e=TppMission.IsHelicopterSpace(vars.missionCode)return n and e
...
local t=not TppMotherBaseManagement.IsPandemicEventMode()return(n and e)and t
end,detailCondition=function()return true
...
end,detailCondition=function()return TppMission.IsHelicopterSpace(vars.missionCode)end,radioList={"f2000_rtrg8261"}},RafeAccidentalDeath={storyCondition=function()local n=e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_OKB_ZERO
local t=TppQuest.IsNowOccurringElapsed()local e=e.GetElapsedMissionCount(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE)==1
return n and(t or e)end,detailCondition=function()return true
end,radioList={"f2000_rtrg8280"}},OpenSideOpsAiPod={storyCondition=function()local i=e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_OKB_ZERO
local t=TppQuest.IsNowOccurringElapsed()local n=e.IsNowOccurringElapsedMission(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE)local e=e.IsMissionCleard(10045)return((t or n)and e)and i
end,detailCondition=function()return true
...
end,detailCondition=function()local e=Player.GetGameObjectIdIsRiddenToLocal()local n=7168
if e~=n then
...
function e.SetMissionOpenFlag(e,n)local e=TppDefine.MISSION_ENUM[tostring(e)]if e then
local t=gvars.str_missionOpenPermission[e]if t then
gvars.str_missionOpenFlag[e]=n
end
end
end
...
function e.CheckAllMissionCleared()local s=true
local a=true
local t=true
local i=true
local r=true
...
local n=TppDefine.MISSING_NUMBER_MISSION_ENUM[e]if not n then
local n=tonumber(e)if(not gvars.str_missionClearedFlag[d])then
...
local t=true
local r={[10240]=true,[10115]=true,[10030]=true}if r[n]then
t=false
end
if t and(TppResult.GetBestRank(n)~=TppDefine.MISSION_CLEAR_RANK.S)then
if TppDefine.HARD_MISSION_ENUM[e]then
o=false
else
i=false
...
function e.CanOpenS10240()local n=e.GetClearedMissionCount{10010,10020,10030,10036,10043,10033,10040,10041,10044,10052,10054,10050,10070,10080,10086,10082,10090,10091,10195,10100,10110,10121,10115,10120,10085,10200,10211,10081,10130,10140,10150,10151,10045,10156,10093,10171}local e=e.IsNowOccurringElapsedMission(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE)local i=TppQuest.IsNowOccurringElapsed()local t=TppMotherBaseManagement.CanOpenS10240()if((n>=36)and t)and(e or i)then
return true
else
return false
end
end
function e.CanOpenS10260()local n=TppDemo.IsPlayedMBEventDemo"DecisionHuey"local i=TppBuddyService.CanSortieBuddyType(BuddyType.QUIET)local r=TppBuddyService.IsDeadBuddyType(BuddyType.QUIET)local e=TppBuddyService.GetFriendlyPoint(BuddyFriendlyType.QUIET)local t=not TppUiCommand.IsUsingButterflyEmblem()if(((n and i)and(not r))and(e>=100))and t then
return true
else
return false
end
...
local t=TppDemo.IsPlayedMBEventDemo"DecisionHuey"local e="tp_m_10160_11"local n=TppMotherBaseManagement.IsGotCassetteTapeTrack(e)local e=TppMotherBaseManagement.IsNewCassetteTapeTrack(e)return(t and n)and not(e)end
function e.CanPlayMgo(e)local e=e or gvars.str_storySequence
...
e.UpdateMissionCleardFlag(n)e.DecreaseElapsedMissionClearCount()e.UpdateDemoFlagQuietWishGoMission()if n~=10050 then
e.ResetCounterReunionQuiet()end
local e=e._UpdateStorySequence()TppTerminal.AcquirePrivilegeStaff()return e
end
...
local r
repeat
i=e.GetStorySequenceTable(n)if i==nil then
return
end
local i=e.CheckNeedProceedStorySequence(i)if not i then
break
end
...
local t={}local function i(n,i)local r=i or{}local i=TppMission.ParseMissionName(n)e.PermitMissionOpen(i)if not r[n]then
table.insert(t,n)e.MissionOpen(i)end
end
if n.main then
i(n.main,n.defaultClose)end
if n.flag then
for t,e in pairs(n.flag)do
i(e,n.defaultClose)end
end
if n.sub then
for t,e in pairs(n.sub)do
i(e,n.defaultClose)end
end
...
function e.IsCompletedMbMedicalSpecialPlatform(t,n,e)if((t==Fox.StrCode32"MotherBase")and(n==Fox.StrCode32"Medical"))and(e==1)then
return true
else
return false
end
...
function e.CanArrivalQuietInMB(t)local n=TppBuddy2BlockController.DidObtainBuddyType(BuddyType.QUIET)local e=not TppBuddyService.CheckBuddyCommonFlag(BuddyCommonFlag.BUDDY_QUIET_HOSPITALIZE)if t then
e=true
end
local i=not TppBuddyService.CheckBuddyCommonFlag(BuddyCommonFlag.BUDDY_QUIET_LOST)local t=not TppBuddyService.IsDeadBuddyType(BuddyType.QUIET)return((n and e)and i)and t
end
...
function e.RequestReunionQuiet()TppBuddyService.UnsetBuddyCommonFlag(BuddyCommonFlag.BUDDY_QUIET_LOST)TppBuddyService.SetObtainedBuddyType(BuddyType.QUIET)TppBuddyService.SetSortieBuddyType(BuddyType.QUIET)TppBuddyService.UnsetBuddyCommonFlag(BuddyCommonFlag.BUDDY_QUIET_DYING)TppBuddyService.SetFriendlyPoint(BuddyFriendlyType.QUIET,100)e.ResetCounterReunionQuiet()TppMotherBaseManagement.RefreshQuietStatus()end
function e.UpdateCounterReunionQuiet()gvars.str_quietReunionMissionCount=gvars.str_quietReunionMissionCount+1
end
function e.ResetCounterReunionQuiet()gvars.str_quietReunionMissionCount=0
end
function e.CanPlayReunionQuietMission()return gvars.str_quietReunionMissionCount>=TppDefine.QUIET_REUNION_MISSION_COUNT
end
function e.CanReunionQuiet()return gvars.str_quietReunionMissionCount>TppDefine.QUIET_REUNION_MISSION_COUNT
end
function e.CanArrivalLiquidInMB()local e=e.GetCurrentStorySequence()>=TppDefine.STORY_SEQUENCE.CLEARD_WHITE_MAMBA
local n=not TppDemo.IsPlayedMBEventDemo"TheGreatEscapeLiquid"return e and n
end
function e.CanArrivalHueyInMB()local e=e.GetCurrentStorySequence()>=TppDefine.STORY_SEQUENCE.CLEARD_RESCUE_HUEY
local n=not TppDemo.IsPlayedMBEventDemo"DecisionHuey"return e and n
end
...
function e.GetCurrentFreeHeliRadioList()return mvars.str_currentFreeHeliRadioList
end
...
function e.DEBUG_SetStorySequence(t,o)if Tpp.IsMaster()then
return
end
...
local function r(t,o,a,i,n)local r=n or{}local n=TppMission.ParseMissionName(t)local i=(t==i)e.PermitMissionOpen(n)if(not r[t])or(i)then
e.MissionOpen(n)if(o<a)and(not i)then
...
if e.main then
local e=r(e.main,i,t,o,e.defaultClose)n=n or e
end
if e.flag then
for s,a in pairs(e.flag)do
local e=r(a,i,t,o,e.defaultClose)n=n or e
end
end
if e.sub then
...
if DebugMenu then
function e.QARELEASE_DEBUG_Init()mvars.qaDebug.showStorySequence=false
...
DebugMenu.AddDebugMenu("LuaSystem","OpenAllMission","bool",mvars.qaDebug,"openAllMission")mvars.qaDebug.allMissionTaskClear=false
DebugMenu.AddDebugMenu("LuaSystem","AllMissionTaskClear","bool",mvars.qaDebug,"allMissionTaskClear")mvars.qaDebug.forceAllSRank=false
DebugMenu.AddDebugMenu("LuaSystem","forceAllSRank","bool",mvars.qaDebug,"forceAllSRank")end
function e.QAReleaseDebugUpdate()local i=5
local n=svars
local n=mvars
local t=DebugText.NewContext()if n.qaDebug.showStorySequence then
DebugText.Print(t,"")DebugText.Print(t,{.5,.5,1},"LuaSystem showStorySequnce")DebugText.Print(t," Current story sequnce = "..tostring(e.GetStorySequenceName(gvars.str_storySequence)))end
if n.qaDebug.showMissionOpenPermission then
DebugText.Print(t,"")DebugText.Print(t,{.5,.5,1},"LuaSystem showPermitOpen")local n={}local r,e=0,1
for o,t in ipairs(TppDefine.MISSION_LIST)do
local o=o-1
if gvars.str_missionOpenPermission[o]then
e=math.floor(r/i)+1
if n[e]then
n[e]=n[e]..(", "..tostring(t))else
n[e]="  "..tostring(t)end
r=r+1
end
end
for e=1,e do
DebugText.Print(t,n[e])end
end
if n.qaDebug.showOpenMission then
DebugText.Print(t,"")DebugText.Print(t,{.5,.5,1},"LuaSystem showOpenMission")local n={}local r,e=0,1
for o,t in ipairs(TppDefine.MISSION_LIST)do
local o=o-1
...
DebugText.Print(t,"")DebugText.Print(t,{.5,.5,1},"LuaSystem showCleardMission")local n={}local r,e=0,1
for o,t in ipairs(TppDefine.MISSION_LIST)do
local o=o-1
...
TppMission.ReserveMissionClearOnRideOnHelicopter()else
...
for n,t in pairs(TppDefine.MISSION_ENUM)do
local t=TppDefine.MISSING_NUMBER_MISSION_ENUM[n]if not t then
local n=tonumber(n)e.PermitMissionOpen(n)e.MissionOpen(n)end
end
e.StartElapsedMissionEvent(TppDefine.ELAPSED_MISSION_EVENT.FAILED_RETAKE_THE_PLATFORM,TppDefine.INIT_ELAPSED_MISSION_COUNT.FAILED_RETAKE_THE_PLATFORM)end
if n.qaDebug.allMissionTaskClear then
n.qaDebug.allMissionTaskClear=false
for n,e in pairs(TppResult.MISSION_TASK_LIST)do
for t,e in ipairs(e)do
local e=TppUI._GetLastCompletedFlagIndex(n,e)gvars.ui_isTaskLastComleted[e]=true
end
end
end
if n.qaDebug.forceAllSRank then
n.qaDebug.forceAllSRank=false
local e={"10010","10020","10036","10043","10033","10040","10041","10044","10052","10054","10050","10070","10080","10086","10082","10090","10195","10091","10100","10110","10121","10120","10085","10200","10211","10081","10130","10140","10150","10151","10045","10156","10093","10171","10260","10280","11043","11054","11082","11090","11033","11050","11140","11080","11121","11130","11044","11151"}for n,e in pairs(e)do
local e=TppDefine.MISSION_ENUM[e]gvars.res_bestRank[e]=TppDefine.MISSION_CLEAR_RANK.S
end
gvars.res_bestRank[TppDefine.MISSION_ENUM["10043"]]=TppDefine.MISSION_CLEAR_RANK.B
end
end
end
if DebugMenu then
...
e.DEBUG_SetStorySequence(TppDefine.STORY_SEQUENCE.CLEARD_THE_TRUTH)DebugMenu.SetDebugMenuValue("MotherBaseManagement","SetAll","Set")end
function e.DEBUG_StoryVars()for n,e in pairs(TppDefine.MISSION_ENUM)do
if gvars.str_missionOpenPermission[e]then
end
end
for n,e in pairs(TppDefine.MISSION_ENUM)do
